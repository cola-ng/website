...
-- Table: learn_scene_progress - Track user learn progress in scenes
CREATE TABLE IF NOT EXISTS learn_scene_progress (
...
CREATE INDEX IF NOT EXISTS idx_learn_scene_progress_user ON learn_scene_progress(user_id);
CREATE INDEX IF NOT EXISTS idx_learn_scene_progress_scene ON learn_scene_progress(scene_id);
